 ...
 * @author yyoshino
 */
@Repository("dpsJknGrpDao")
public class DpsJknGrpDaoImpl extends AbstractDao implements DpsJknGrpDao {

	private static final String SQL_MAP = "DPS_C_JKN_GRP_SqlMap";
