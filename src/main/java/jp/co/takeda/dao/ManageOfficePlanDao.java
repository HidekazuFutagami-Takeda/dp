 ...
 * @author khashimoto
 */
public interface ManageOfficePlanDao {
	 ...
	 * @throws DataNotFoundException
	 */
	ManageOfficePlan searchUk(InsType insType, String prodCode, String sosCd) throws DataNotFoundException;
	 ...
	 * @throws DataNotFoundException
	 */
	List<ManageOfficePlan> searchListByProd(String sortString, String prodCode, String sosCd2) throws DataNotFoundException;
	 ...
	 * @throws DataNotFoundException
	 */
	List<ManageOfficePlan> searchListBySos(String sortString, String sosCd, String category, String vaccineCode) throws DataNotFoundException;

	/**
	 * 管理の営業所別計画を登録する。
	 * 
	 * 
	 * @param manageOfficePlan 管理の営業所別計画
	 * @param pgId PGID
	 * @throws DuplicateException
	 */
	void insert(ManageOfficePlan manageOfficePlan, String pgId) throws DuplicateException;
	 ...
	 * @return 更新件数
	 */
	int update(ManageOfficePlan manageOfficePlan, String pgId);
