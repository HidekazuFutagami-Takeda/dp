 ...
 * @author khashimoto
 */
public interface ManageChangeParamBTDao {
	 ...
	 * @return 変換パラメータ(B→T価)
	 */
	ChangeParamBT searchUk(String calYear, Term calTerm, String prodCode, String tmsTytenCdHonten) throws DataNotFoundException;
	...
	/**
	 * 変換パラメータ(B→T価)を使用して、変換した計画値を取得する。
	 * 
	 * 
	 * @param prodCode 品目固定コード
	 * @param value 計画値
	 ...
	 * @return 変換後の計画値
	 */
	Long getChangeValue(String prodCode, Long value, ValueChangeType valueChangeType, String tmsTytenCd);
