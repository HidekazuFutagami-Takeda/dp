 ...
 * @author khashimoto
 */
@Repository("dpmSyComInsOyakoDao")
public class DpmSyComInsOyakoDaoImpl extends AbstractDao implements DpmSyComInsOyakoDao {

	private static final String SQL_MAP = "DPM_C_SY_COM_INS_OYAKO_SqlMap";
