 ...
 * @author siwamoto
 */
public interface DpsDeliveryResultMrSearchService {
	 ...
	 */
	DeliveryResultMrListDto searchDeliveryResultMrList(DeliveryResultMrScDto scDto) throws LogicalException;
