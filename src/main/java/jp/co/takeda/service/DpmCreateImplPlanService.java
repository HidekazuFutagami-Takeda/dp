 ...
 * @author khashimoto
 */
public interface DpmCreateImplPlanService {
	 ...
	 */
	ImplPlan getImplPlan(String prodCode, Long value, InsType insType, ValueChangeType valueChangeType, String tmsTytenCd, ImplPlan implPlan) throws LogicalException;
