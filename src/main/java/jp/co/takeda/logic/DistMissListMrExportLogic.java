 ...
 * @author stakeuchi
 */
public class DistMissListMrExportLogic {
	 ...
	 */
	public DistMissListMrExportLogic(String templatePath, Date systemDate, OutputFile outputFile, List<MrDistMiss> mrDistMissList, MessageSource messageSource) {
		// ----------------------
		// 引数チェック
		// ----------------------
