...
/**
 * 施設情報の検索結果用DTOを生成するロジッククラス
 *
 * @author khashimoto
 */
public class CreateInsMstScResultDtoLogic {

	/**
	 * 施設情報
	 */
	private final InsMst insMst;
	 ...
	 * @param insMst 施設情報
	 */
	public CreateInsMstScResultDtoLogic(InsMst insMst) {
		this.insMst = insMst;
	}
	...
	public InsMstResultDto convert() {
		...
		// 対象
		final String insType = HoInsType.getHoInsTypeName(insMst.getHoInsType());
...
//add Start 2025/04/247 H.Futagami 施設検索の担当者表示の変更
		// 従業員番号(BU2CSMR)
