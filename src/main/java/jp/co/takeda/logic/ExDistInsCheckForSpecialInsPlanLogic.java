 ...
 * @author khashimoto
 */
public class ExDistInsCheckForSpecialInsPlanLogic {
	 ...
	 */
	public ExDistInsCheckForSpecialInsPlanLogic(InsMstDAO insMstDAO, PlannedProdDAO plannedProdDAO, ExceptDistInsDao exceptDistInsDao, List<SpecialInsPlan> specialInsPlanList) {
	...
	public void check(PlanType planType) throws LogicalException {
		...
		for (SpecialInsPlan insPlan : specialInsPlanList) {
			// 登録対象外の場合、次へ
			if (insPlan.getPlannedValueY() == null) {
				continue;
			}
