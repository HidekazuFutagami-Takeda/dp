...
//
///**
// * 業務進捗表(医)[営業所計画-施設特約店別計画(ONC)]を表すDTOクラス
// *
// * @author tkawabata
// */
//public class ProgressPlanONCStatusDto extends ProgressPlanStatusDto {
//
//	/**
//	 * serialVersionUID
//	 */
...
//	 */
//	public ProgressPlanONCStatusDto(BumonRank bumonRank, List<SosStatusSummary> sosStatusSummaryList, List<JgiStatusSummary> jgiStatusSummaryList) {
