...
/**
 * 特定施設個別計画（営業所案）の登録用DTO
 *
 * @author khashimoto
 */
public class SpecialInsPlanModifyForOfficeDto extends DpDto {
	 ...
	 * @param prodCategory
	 */
	public SpecialInsPlanModifyForOfficeDto(Integer jgiNo, String insNo, List<SpecialInsPlanDto> inputList, Date upDate, String sosCd3, String prodCategory) {
		this.jgiNo = jgiNo;
		this.insNo = insNo;
