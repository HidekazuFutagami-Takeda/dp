...
/**
 * 
 * (医)施設特約店別計画編集画面登録用DTO
 * 
 * @author siwamoto
 */
public class ManageInsWsPlanProdEntryDto extends DpDto {
	 ...
	 */
	public ManageInsWsPlanProdEntryDto(String prodCode, String insNo, String tmsTytenCd, Long seqKey, Date upDate, Long baseTBefore, Long baseTAfter) {
