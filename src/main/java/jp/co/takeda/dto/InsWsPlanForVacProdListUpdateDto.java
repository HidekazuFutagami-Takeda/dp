...
/**
 * ワクチン用施設特約店別計画 品目一覧更新用DTO
 * 
 * @author nozaki
 */
public class InsWsPlanForVacProdListUpdateDto extends DpDto {
	 ...
	 */
	public InsWsPlanForVacProdListUpdateDto(String prodCode, String prodName, Date upDate) {
