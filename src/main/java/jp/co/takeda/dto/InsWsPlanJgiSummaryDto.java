...
/**
 * 施設特約店別計画担当者単位のサマリーを表すDTO
 * 
 * @author khashimoto
 */
public class InsWsPlanJgiSummaryDto extends DpDto {
	 ...
	 */
	public InsWsPlanJgiSummaryDto(Integer jgiNo, String prodCode, Long distValueUhY, Long plannedValueUhY, Long distValuePY, Long plannedValuePY) {
		this.jgiNo = jgiNo;
