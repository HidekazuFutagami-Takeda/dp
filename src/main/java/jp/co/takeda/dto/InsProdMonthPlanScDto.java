 ...
 * @author stakeuchi
 */
public class InsProdMonthPlanScDto extends DpDto {
	 ...
	 */
	public InsProdMonthPlanScDto(Integer jgiNo, String insNo, String prodCategory, PlanData planData, String vaccineCode) {
		this.jgiNo = jgiNo;
		this.insNo = insNo;
