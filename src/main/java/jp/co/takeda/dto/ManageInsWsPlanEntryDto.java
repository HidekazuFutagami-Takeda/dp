 ...
 * @author siwamoto
 */
public class ManageInsWsPlanEntryDto extends DpDto {
	 ...
	 */
	public ManageInsWsPlanEntryDto(String prodCode, String insNo, String tmsTytenCd, Long seqKey, Date upDate, Long baseTBefore, Long baseTAfter) {
