...
//
///**
// * 業務進捗表(医)[営業所計画-施設特約店別計画(MMP)]を表すDTOクラス
// *
// * @author tkawabata
// */
//public class ProgressPlanMMPStatusDto extends ProgressPlanStatusDto {
//
//	/**
//	 * serialVersionUID
//	 */
...
//	 */
//	public ProgressPlanMMPStatusDto(BumonRank bumonRank, List<SosStatusSummary> sosStatusSummaryList, List<JgiStatusSummary> jgiStatusSummaryList) {
