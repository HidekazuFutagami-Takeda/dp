...
//
///**
// * 業務進捗表(医)[営業所計画-施設特約店別計画(SPBU)]を表すDTOクラス
// *
// * @author mwada
// */
//public class ProgressPlanSPBUStatusDto extends ProgressPlanStatusDto {
//
//	/**
//	 * serialVersionUID
//	 */
...
//	 */
//	public ProgressPlanSPBUStatusDto(BumonRank bumonRank, List<SosStatusSummary> sosStatusSummaryList, List<JgiStatusSummary> jgiStatusSummaryList) {
