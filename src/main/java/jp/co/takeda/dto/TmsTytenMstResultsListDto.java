 ...
 * @author khashimoto
 */
public class TmsTytenMstResultsListDto extends DpDto {
	 ...
	 */
	public TmsTytenMstResultsListDto(List<TmsTytenMstUn> tmsTytenMstList) {
	 ...
	 * @param tmsTytenMstList 特約店基本統合のリスト
	 */
	public TmsTytenMstResultsListDto(TmsTytenMstUn tmsTytenMstUn, List<TmsTytenMstUn> tmsTytenMstList) {
		this.tmsTytenMstList = tmsTytenMstList;
