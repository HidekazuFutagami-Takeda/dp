 ...
 * @author siwamoto
 */
public class InsWsPlanForVacProdAdminDto extends DpDto {
	 ...
	 * @param prodSumRowFlg
	 */
	public InsWsPlanForVacProdAdminDto(String prodName, String prodCode, Long baseB, Long beforeBaseT, Long baseT, String upDateJgiName, Date upDate, boolean prodSumRowFlg) {
		super();
