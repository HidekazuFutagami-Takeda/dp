 ...
 * @author nozaki
 */
public class MrPlanUpdateDto extends DpDto {
	 ...
	 * @param mrPlanList 更新対象の担当者別計画リスト
	 */
	public MrPlanUpdateDto(PlannedProd plannedProd, InsType insType, List<MrPlanDto> mrPlanDtoList) {
