...
/**
 * 施設特約店別計画配分対象品目 更新用DTO
 * 
 * @author stakeuchi
 */
public class InsWsDistProdUpdateDto extends DpDto {
	 ...
	 */
	public InsWsDistProdUpdateDto(String prodCode, String prodName, Date statusLastUpdate) {
