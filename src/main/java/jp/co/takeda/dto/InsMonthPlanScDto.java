 ...
 * @author stakeuchi
 */
public class InsMonthPlanScDto extends DpDto {
	 ...
	 */
	public InsMonthPlanScDto(String sosCd2, String sosCd3, String sosCd4,Integer jgiNo,String insNo, InsType insType, String prodCategory, String prodCode, PlanData planData) {
		this.sosCd2 = sosCd2;
		this.sosCd3 = sosCd3;
		this.sosCd4 = sosCd4;
		this.jgiNo = jgiNo;
