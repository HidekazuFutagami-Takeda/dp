...
/**
 * 
 * ワクチン用施設特約店別計画編集画面登録用DTO
 * 
 * @author nozaki
 */
public class ManageInsWsPlanForVacEntryDto extends DpDto {
	 ...
	 */
	public ManageInsWsPlanForVacEntryDto(String prodCode, String insNo, String tmsTytenCd, Long seqKey, Date upDate, Long baseTBefore, Long baseTAfter) {
