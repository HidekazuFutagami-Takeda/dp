 ...
 * @author siwamoto
 */
public class ManageWsPlanEntryDto extends DpDto {
	 ...
	 */
	public ManageWsPlanEntryDto(String prodCode, String tmsTytenCd, InsType insType, Long seqKey, Date upDate, Long baseTBefore, Long baseTAfter) {
		super();
