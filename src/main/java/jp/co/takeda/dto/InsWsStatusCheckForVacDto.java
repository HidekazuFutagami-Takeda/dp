...
/**
 * ワクチン用施設特約店別計画立案ステータスチェック用DTO
 * 
 * @author nozaki
 */
public class InsWsStatusCheckForVacDto extends DpDto {
	...
	/**
	 * コンストラクタ <br>
	 * 組織コード(特約店G)、計画対象品目を指定する。
	 * 
	 * @param sosCd3 チェック対象の組織コード(特約店G)
	 * @param jgiMstList チェック対象の従業員情報
	 * @param plannedProdList チェック対象の計画対象品目
	 * @param insWsStatusForCheckList 許可しない施設特約店別計画立案ステータス
	 */
	public InsWsStatusCheckForVacDto(String sosCd3, List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsWsStatusForCheck> insWsStatusForCheckList) {
	...
	/**
	 * コンストラクタ <br>
	 * 組織コード(特約店G)、組織コード(チーム)、計画対象品目を指定する。
	 * 
	 * @param sosCd3 チェック対象の組織コード(特約店G)
	 ...
	 * @param insWsStatusForCheckList 許可しない施設特約店別計画立案ステータス
	 */
	public InsWsStatusCheckForVacDto(String sosCd3, String sosCd4, List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsWsStatusForCheck> insWsStatusForCheckList) {
	 ...
	 * @param insWsStatusForCheckList 許可しない施設特約店別計画立案ステータス
	 */
	public InsWsStatusCheckForVacDto(List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsWsStatusForCheck> insWsStatusForCheckList) {
	...
	/**
	 * チェック対象の部門ランク(特約店G、チーム、担当者)を取得する。
	 * 
	 * @return チェック対象の部門ランク(特約店G、チーム、担当者)
	 */
	...
	/**
	 * チェック対象の組織コード(特約店G)を取得する。
	 * 
	 * @return チェック対象の組織コード(特約店G)
	 */
