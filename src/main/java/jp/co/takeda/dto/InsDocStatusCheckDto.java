...
/**
 * 施設医師別計画立案ステータスチェック用DTO
 * 
 * @author nozaki
 */
public class InsDocStatusCheckDto extends DpDto {
	 ...
	 * @param insDocStatusForCheckList 許可しない施設医師別計画立案ステータス
	 */
	public InsDocStatusCheckDto(String sosCd3, List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsDocStatusForCheck> insDocStatusForCheckList) {
		...
		this.insDocStatusForCheckList = insDocStatusForCheckList;
	 ...
	 * @param insDocStatusForCheckList 許可しない施設医師別計画立案ステータス
	 */
	public InsDocStatusCheckDto(String sosCd3, String sosCd4, List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsDocStatusForCheck> insDocStatusForCheckList) {
	 ...
	 * @param insDocStatusForCheckList 許可しない施設医師別計画立案ステータス
	 */
	public InsDocStatusCheckDto(List<JgiMst> jgiMstList, List<PlannedProd> plannedProdList, List<InsDocStatusForCheck> insDocStatusForCheckList) {
	...
	/**
	 * 許可しない施設医師別計画立案ステータスのリストを取得する。
	 * 
	 * @return 許可しない施設医師別計画立案ステータスのリスト
	 */
	public List<InsDocStatusForCheck> getInsDocStatusForCheck() {
		return insDocStatusForCheckList;
	}
