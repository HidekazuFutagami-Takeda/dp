 ...
 * @author khashimoto
 */
public class InsWsPlanForVacUpDateScDto extends DpDto {
	 ...
	 * @param category カテゴリ
	 */
	public InsWsPlanForVacUpDateScDto(String jgiNo, String prodCode, String insType, String refProdCode, boolean refProdAllFlg, String category) {
