 ...
 * @author khashimoto
 */
public class ChoseiMr extends DpManageModel<ChoseiMr> {
	...
	@Override
	public int compareTo(ChoseiMr obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ChoseiMr.class.isAssignableFrom(entry.getClass())) {
			ChoseiMr obj = (ChoseiMr) entry;
