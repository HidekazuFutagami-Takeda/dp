 ...
 * @author khashimoto
 */
public class ManageInsPlan extends DpManageModel<ManageInsPlan> {
	...
	@Override
	public int compareTo(ManageInsPlan obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ManageInsPlan.class.isAssignableFrom(entry.getClass())) {
			ManageInsPlan obj = (ManageInsPlan) entry;
