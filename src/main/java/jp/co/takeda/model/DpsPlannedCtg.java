 ...
 * @author
 */
public class DpsPlannedCtg extends DpModel<DpsPlannedCtg> {
	...
	@Override
	public int compareTo(DpsPlannedCtg obj) {
		if (obj != null) {
			return new CompareToBuilder().append(this.calYear,obj.calYear).append(this.calTrm,obj.calTrm).append(this.trtGrpCd,obj.trtGrpCd)
					.append(this.trtCd,obj.trtCd).append(this.category,obj.category).append(this.oyakoKb,obj.oyakoKb).append(this.oyakoKb2,obj.oyakoKb2).append(this.tgtInsKb,obj.tgtInsKb)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DpsPlannedCtg other = (DpsPlannedCtg) obj;
		if (calTrm == null) {
		...
		if (oyakoKb == null) {
			...
			return false;
		if(oyakoKb2 == null) {
			if (other.oyakoKb2 != null)
				return false;
		}else if(!oyakoKb2.equals(other.oyakoKb2))
			return false;
	...
	public int hashCode() {
		...
		result = prime * result + ((oyakoKb2 == null) ? 0 : oyakoKb.hashCode());
