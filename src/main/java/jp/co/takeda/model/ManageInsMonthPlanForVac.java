...
/**
 * 管理時のワクチン用施設別計画を表すモデルクラス
 * 
 * @author khashimoto
 */
public class ManageInsMonthPlanForVac extends DpManageModel<ManageInsMonthPlanForVac> {
	...
	@Override
	public int compareTo(ManageInsMonthPlanForVac obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ManageInsMonthPlanForVac.class.isAssignableFrom(entry.getClass())) {
			ManageInsMonthPlanForVac obj = (ManageInsMonthPlanForVac) entry;
