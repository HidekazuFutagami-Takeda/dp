...
/**
 * 施設特約店別計画ステータスのサマリーを表すクラス
 *
 * @author khashimoto
 */
public class InsWsPlanStatSum implements Serializable {
	 ...
	 * 施設特約店別計画確定日時
	 */
	private Integer exceptPlanCount;
	//---------------------
	// Getter & Setter
	// --------------------
	 ...
	 * 施設特約店別計画公開の件数を設定する。
	 *
	 * @param planOpened 施設特約店別計画公開の件数
	 */
	 ...
	 * 施設特約店別計画確定の件数を設定する。
	 *
	 * @param planCompleted 施設特約店別計画確定の件数
	 */
	...
	/**
	 * 計画立案対象外施設への計画の数を返す
	 * @return exceptPlanCount
	 */
	public Integer getExceptPlanCount() {
		return exceptPlanCount;
	}

	/**
	 * 計画立案対象外施設への計画の数を設定する。
	 * @param exceptPlanCount セットする exceptPlanCount
	 */
	public void setExceptPlanCount(Integer exceptPlanCount) {
		this.exceptPlanCount = exceptPlanCount;
	}
