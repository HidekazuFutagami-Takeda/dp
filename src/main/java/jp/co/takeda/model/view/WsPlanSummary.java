 ...
 * @author khashimoto
 */
public class WsPlanSummary extends Model<WsPlanSummary> {
	...
	@Override
	public int compareTo(WsPlanSummary obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && WsPlanSummary.class.isAssignableFrom(entry.getClass())) {
			WsPlanSummary obj = (WsPlanSummary) entry;
