 ...
 * @author khashimoto
 */
public class WsPlanForVacSummary extends Model<WsPlanForVacSummary> {
	...
	@Override
	public int compareTo(WsPlanForVacSummary obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && WsPlanForVacSummary.class.isAssignableFrom(entry.getClass())) {
			WsPlanForVacSummary obj = (WsPlanForVacSummary) entry;
