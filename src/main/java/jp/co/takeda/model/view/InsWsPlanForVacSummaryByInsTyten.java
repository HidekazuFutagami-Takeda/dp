 ...
 * @author YTaniguchi
 */
public class InsWsPlanForVacSummaryByInsTyten extends DpModel<InsWsPlanForVacSummaryByInsTyten> {
	 ...
	 * TMS特約店名称（漢字）を設定する。
	 *
	 * @param insFormalName TMS特約店名称（漢字）
	 */
	...
	@Override
	public int compareTo(InsWsPlanForVacSummaryByInsTyten obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && InsWsPlanForVacSummaryByInsTyten.class.isAssignableFrom(entry.getClass())) {
			InsWsPlanForVacSummaryByInsTyten obj = (InsWsPlanForVacSummaryByInsTyten) entry;
