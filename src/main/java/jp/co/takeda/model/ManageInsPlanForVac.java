 ...
 * @author khashimoto
 */
public class ManageInsPlanForVac extends DpManageModel<ManageInsPlanForVac> {
	...
	@Override
	public int compareTo(ManageInsPlanForVac obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ManageInsPlanForVac.class.isAssignableFrom(entry.getClass())) {
			ManageInsPlanForVac obj = (ManageInsPlanForVac) entry;
