 ...
 *
 */
public final class DpmCCdMst extends Model<DpmCCdMst> {
	...
	@Override
	public int compareTo(DpmCCdMst obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && DpmCCdMst.class.isAssignableFrom(entry.getClass())) {
			DpmCCdMst obj = (DpmCCdMst) entry;
