 ...
 * @author khashimoto
 */
public class ImplPlan implements Serializable {
	 ...
	 * 実施計画1（Y価）
	 */
	protected Long planned1ValueY;

	/**
	 * 実施計画1（T価）
	 */
	protected Long planned1ValueT;

	/**
	 * 実施計画2（Y価）
	 */
	protected Long planned2ValueY;

	/**
	 * 実施計画2（T価）
	 */
	protected Long planned2ValueT;

	/**
	 * 変更前実施計画1（Y価）
	 */
	protected Long befPlanned1ValueY;

	/**
	 * 変更前実施計画1（T価）
	 */
	protected Long befPlanned1ValueT;

	/**
	 * 変更前実施計画2（Y価）
	 */
	protected Long befPlanned2ValueY;

	/**
	 * 変更前実施計画2（T価）
	 */
	protected Long befPlanned2ValueT;
	 ...
	 * 変更前実施計画1（Y価）を設定する。
	 * 
	 * @param befPlanned1ValueY 変更前実施計画1（Y価）
	 */
	 ...
	 * 変更前実施計画2（Y価）を設定する。
	 * 
	 * @param befPlanned2ValueY 変更前実施計画2（Y価）
	 */
