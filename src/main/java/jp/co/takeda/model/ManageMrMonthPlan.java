...
/**
 * 管理時の担当者別月別計画を表すモデルクラス
 *
 * @author khashimoto
 */
public class ManageMrMonthPlan extends DpManageModel<ManageMrMonthPlan> {
	 ...
	 * 下位計画・月初計画積上値(1月目)
	 */
	private Long plannedStacked1Value;

	/**
	 * 下位計画・月初計画積上値(2月目)
	 */
	private Long plannedStacked2Value;

	/**
	 * 下位計画・月初計画積上値(3月目)
	 */
	private Long plannedStacked3Value;

	/**
	 * 下位計画・月初計画積上値(4月目)
	 */
	private Long plannedStacked4Value;

	/**
	 * 下位計画・月初計画積上値(5月目)
	 */
	private Long plannedStacked5Value;

	/**
	 * 下位計画・月初計画積上値(6月目)
	 */
	private Long plannedStacked6Value;

	/**
	 * 下位計画・月末見込積上値(1月目)
	 */
	private Long expectedStacked1Value;

	/**
	 * 下位計画・月末見込積上値(2月目)
	 */
	private Long expectedStacked2Value;

	/**
	 * 下位計画・月末見込積上値(3月目)
	 */
	private Long expectedStacked3Value;

	/**
	 * 下位計画・月末見込積上値(4月目)
	 */
	private Long expectedStacked4Value;

	/**
	 * 下位計画・月末見込積上値(5月目)
	 */
	private Long expectedStacked5Value;

	/**
	 * 下位計画・月末見込積上値(6月目)
	 */
	private Long expectedStacked6Value;

	/**
	 * 期別計画値
	 */
	private Long plannedTermValue;
...
//add End 2022/08/25 R.takamoto No.8　計画管理の月別計画に納入実績の値を表示
	...
	@Override
	public int compareTo(ManageMrMonthPlan obj) {
		if (obj != null) {
			return new CompareToBuilder().append(this.insType, obj.insType).append(this.jgiNo, obj.jgiNo)
	...
	public boolean equals(Object entry) {
		if (entry != null && ManageMrMonthPlan.class.isAssignableFrom(entry.getClass())) {
			ManageMrMonthPlan obj = (ManageMrMonthPlan) entry;
			return new EqualsBuilder().append(this.insType, obj.insType).append(this.jgiNo, obj.jgiNo)
