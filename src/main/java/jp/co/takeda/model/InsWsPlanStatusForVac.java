...
/**
 * (ワクチン)施設特約店別計画ステータスを表すモデルクラス
 * 
 * @author tkawabata
 */
public class InsWsPlanStatusForVac extends DpModel<InsWsPlanStatusForVac> implements Cloneable {
	...
	@Override
	public int compareTo(InsWsPlanStatusForVac obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && InsWsPlanStatusForVac.class.isAssignableFrom(entry.getClass())) {
			InsWsPlanStatusForVac obj = (InsWsPlanStatusForVac) entry;
	...
	@Override
	public InsWsPlanStatusForVac clone() {
		if (this == null) {
			return null;
		}
		InsWsPlanStatusForVac insWsPlanStatusForVac = new InsWsPlanStatusForVac();
		insWsPlanStatusForVac.setSeqKey(this.seqKey);
		insWsPlanStatusForVac.setJgiNo(this.jgiNo);
		insWsPlanStatusForVac.setProdCode(this.prodCode);
		insWsPlanStatusForVac.setStatusForInsWsPlan(this.statusForInsWsPlan);
		insWsPlanStatusForVac.setDistStartDate(this.distStartDate);
		insWsPlanStatusForVac.setDistEndDate(this.distEndDate);
		insWsPlanStatusForVac.setInsWsOpenDate(this.insWsOpenDate);
		insWsPlanStatusForVac.setInsWsFixDate(this.insWsFixDate);
		insWsPlanStatusForVac.setIsJgiNo(this.isJgiNo);
		insWsPlanStatusForVac.setIsJgiName(this.isJgiName);
		insWsPlanStatusForVac.setIsDate(this.isDate);
		insWsPlanStatusForVac.setUpJgiNo(this.isJgiNo);
		insWsPlanStatusForVac.setUpJgiName(this.upJgiName);
		insWsPlanStatusForVac.setUpDate(this.upDate);
		return insWsPlanStatusForVac;
	}
}
