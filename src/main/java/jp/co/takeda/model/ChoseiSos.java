 ...
 * @author khashimoto
 */
public class ChoseiSos extends DpManageModel<ChoseiSos> {
	...
	@Override
	public int compareTo(ChoseiSos obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ChoseiSos.class.isAssignableFrom(entry.getClass())) {
			ChoseiSos obj = (ChoseiSos) entry;
