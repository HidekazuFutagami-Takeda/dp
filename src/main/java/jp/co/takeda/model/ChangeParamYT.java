 ...
 * @author tkawabata
 */
public class ChangeParamYT extends DpModel<ChangeParamYT> {
	 ...
	 * 変換率(Z)を取得する。
	 *
	 * @return changeRateZ 変換率(Z)
	 */
	public Double getChangeRateZ() {
		return changeRateZ;
	}
	 ...
	 * 変換率(Z)を設定する。
	 *
	 * @param changeRateZ 変換率(Z)
	 */
	public void setChangeRateZ(Double changeRateZ) {
		this.changeRateZ = changeRateZ;
	}

	@Override
	public int compareTo(ChangeParamYT obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && ChangeParamYT.class.isAssignableFrom(entry.getClass())) {
			ChangeParamYT obj = (ChangeParamYT) entry;
