 ...
 * @author khashimoto
 */
public class MasterManagePlannedProd extends DpManageModel<MasterManagePlannedProd> {
	...
	@Override
	public int compareTo(MasterManagePlannedProd obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && MasterManagePlannedProd.class.isAssignableFrom(entry.getClass())) {
			MasterManagePlannedProd obj = (MasterManagePlannedProd) entry;
