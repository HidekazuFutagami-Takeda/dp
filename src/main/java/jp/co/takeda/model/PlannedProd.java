...
/**
 * 計画支援の計画対象品目を表すモデルクラス
 *
 * @author tkawabata
 */
public class PlannedProd extends DpModel<PlannedProd> {
	 ...
	 * MMP計品目コード
	 */
	public static final String MMP = "99959";
	 ...
	 * 計画立案レベル・施設医師 を設定する。
	 *
	 * @param planLevelInsDoc 計画立案レベル・施設医師
	 */
	...
	@Override
	public int compareTo(PlannedProd obj) {
		if (obj != null) {
	...
	public boolean equals(Object entry) {
		if (entry != null && PlannedProd.class.isAssignableFrom(entry.getClass())) {
			PlannedProd obj = (PlannedProd) entry;
