 ...
 * @author khashimoto
 */
public class Dps912C01Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey TMS_LIST_KEY_R = new BoxKeyPerClassImpl(Dps912C01Form.class, TmsTytenMstHontenListDto.class);
