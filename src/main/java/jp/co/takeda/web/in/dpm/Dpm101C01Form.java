...
/**
 * Dpm101C01((医)積上結果表示ダイアログ)のフォームクラス
 *
 * @author stakeuchi
 */
public class Dpm101C01Form extends DiaDpActionForm {
	 ...
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM101C01_DATA_R_SEARCH_RESULT = new BoxKeyPerClassImpl(Dpm101C00Form.class, ProdPlanSummaryResultDto.class);

	/**
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM101C01_DATA_R_FORM = new BoxKeyPerClassImpl(Dpm101C00Form.class, ProdPlanSummaryResultDto.class);

	/**
	 * 編集権限
	 */
	public static final DpAuthority DPM101C01_EDIT_AUTH = new DpAuthority(AuthType.EDIT);
