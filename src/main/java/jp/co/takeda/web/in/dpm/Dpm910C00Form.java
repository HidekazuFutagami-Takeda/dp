 ...
 * @author khashimoto
 */
public class Dpm910C00Form extends DiaDpActionForm {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -7308847825163339650L;

	/**
	 * 組織・従業員検索結果のキー値
	 */
	public static final BoxKey SOS_JGI_LIST_DTO_KEY_R = new BoxKeyPerClassImpl(Dpm910C00Form.class, SosJgiListDto.class);
