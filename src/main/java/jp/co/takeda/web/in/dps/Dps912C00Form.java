 ...
 * @author khashimoto
 */
public class Dps912C00Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey SOS_LIST_KEY_R = new BoxKeyPerClassImpl(Dps912C00Form.class, SosListDto.class);
