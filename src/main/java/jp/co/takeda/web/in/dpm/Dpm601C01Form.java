...
/**
 * Dpm601C01((ワ)施設品目別計画編集画面)のフォームクラス
 *
 * @author stakeuchi
 */
public class Dpm601C01Form extends DpActionForm {
	 ...
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM601C01_DATA_R_SEARCH_RESULT = new BoxKeyPerClassImpl(Dpm601C01Form.class, InsProdPlanForVacResultDto.class);

	/**
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM601C01_DATA_R_HEADER = new BoxKeyPerClassImpl(Dpm601C01Form.class, InsPlanForVacHeaderDto.class);

	/**
	 * 編集権限
	 */
	public static final DpAuthority DPM601C01_EDIT_AUTH = new DpAuthority(AuthType.EDIT);

	/**
	 * 計画立案レベル・施設
	 */
	public static final ProdPlanLevel DPM601C01_PLANLEVEL_INS = ProdPlanLevel.INS;
