 ...
 * @author khashimoto
 */
public class Dpm912C05Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey TMS_LIST_KEY_R = new BoxKeyPerClassImpl(Dpm912C05Form.class, TmsTytenMstResultsTenkaiListDto.class);
	...
	public TmsTytenMstScDto convertTmsTytenMstScDto() throws Exception {
		...
		return new TmsTytenMstScDto(null, searchTmsTytenCd, null, null, null, null, null, null, null, null);
