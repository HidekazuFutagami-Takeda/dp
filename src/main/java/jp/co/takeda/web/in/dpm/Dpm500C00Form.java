...
/**
 * Dpm500C00((医)組織別計画編集画面)のフォームクラス
 *
 * @author stakeuchi
 */
public class Dpm500C00Form extends DpActionForm {
	 ...
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM500C00_DATA_R_SEARCH_RESULT = new BoxKeyPerClassImpl(Dpm500C00Form.class, SosMonthPlanResultDto.class);

	/**
	 * 部門ランクフラグ取得キー
	 */
	public static final BoxKey DPM500C00_DATA_R_BUMON_FLAG = new BoxKeyPerClassImpl(Dpm500C00Form.class, Boolean.class);

	/**
	 * 編集権限
	 */
	public static final DpAuthority DPM500C00_EDIT_AUTH = new DpAuthority(AuthType.EDIT);

	/**
	 * 計画立案レベル・支店
	 */
	public static final ProdPlanLevel DPM500C00_PLANLEVEL_SITEN = ProdPlanLevel.SITEN;

	/**
	 * 計画立案レベル・営業所
	 */
	public static final ProdPlanLevel DPM500C00_PLANLEVEL_OFFICE = ProdPlanLevel.OFFICE;

	/**
	 * 計画立案レベル・チーム
	 */
	public static final ProdPlanLevel DPM500C00_PLANLEVEL_TEAM = ProdPlanLevel.TEAM;

	/**
	 * 計画立案レベル・担当者
	 */
	public static final ProdPlanLevel DPM500C00_PLANLEVEL_MR = ProdPlanLevel.MR;
	 ...
	 * <li>Sprit文字列[1]=従業員番号</li>
	 * <li>Sprit文字列[2]=品目コード</li>
	 * <li>Sprit文字列[3]=シーケンスキー</li>
	 * <li>Sprit文字列[4]=最終更新日時</li>
	 * <li>Sprit文字列[5]=月初計画1(YB価) 更新前</li>
	 * <li>Sprit文字列[6]=月末見込1(YB価) 更新前</li>
	 * <li>Sprit文字列[7]=月初計画2(YB価) 更新前</li>
	 * <li>Sprit文字列[8]=月末見込2(YB価) 更新前</li>
	 * <li>Sprit文字列[9]=月初計画3(YB価) 更新前</li>
	 * <li>Sprit文字列[10]=月末見込3(YB価) 更新前</li>
	 * <li>Sprit文字列[11]=月初計画4(YB価) 更新前</li>
	 * <li>Sprit文字列[12]=月末見込4(YB価) 更新前</li>
	 * <li>Sprit文字列[13]=月初計画5(YB価) 更新前</li>
	 * <li>Sprit文字列[14]=月末見込5(YB価) 更新前</li>
	 * <li>Sprit文字列[15]=月初計画6(YB価) 更新前</li>
	 * <li>Sprit文字列[16]=月末見込6(YB価) 更新前</li>
	 * <li>Sprit文字列[17]=月初計画1(YB価) 更新後</li>
	 * <li>Sprit文字列[18]=月末見込1(YB価) 更新後</li>
	 * <li>Sprit文字列[19]=月初計画2(YB価) 更新後</li>
	 * <li>Sprit文字列[20]=月末見込2(YB価) 更新後</li>
	 * <li>Sprit文字列[21]=月初計画3(YB価) 更新後</li>
	 * <li>Sprit文字列[22]=月末見込3(YB価) 更新後</li>
	 * <li>Sprit文字列[23]=月初計画4(YB価) 更新後</li>
	 * <li>Sprit文字列[24]=月末見込4(YB価) 更新後</li>
	 * <li>Sprit文字列[25]=月初計画5(YB価) 更新後</li>
	 * <li>Sprit文字列[26]=月末見込5(YB価) 更新後</li>
	 * <li>Sprit文字列[27]=月初計画6(YB価) 更新後</li>
	 * <li>Sprit文字列[28]=月末見込6(YB価) 更新後</li>
	 * </ul>
	 */
	...
	public List<SosMonthPlanUpdateDto> convertSosPlanUpdateDto() throws Exception {
		...
		if (rowIdList != null) {
			for (int i = 0; i < rowIdList.length; i++) {
				...
				final boolean isExpected1Same = StringUtils.equals(rowId[6], rowId[18]);
				final boolean isPlanned2Same = StringUtils.equals(rowId[7], rowId[19]);
				final boolean isExpected2Same = StringUtils.equals(rowId[8], rowId[20]);
				final boolean isPlanned3Same = StringUtils.equals(rowId[9], rowId[21]);
				final boolean isExpected3Same = StringUtils.equals(rowId[10], rowId[22]);
				final boolean isPlanned4Same = StringUtils.equals(rowId[11], rowId[23]);
				final boolean isExpected4Same = StringUtils.equals(rowId[12], rowId[24]);
				final boolean isPlanned5Same = StringUtils.equals(rowId[13], rowId[25]);
				final boolean isExpected5Same = StringUtils.equals(rowId[14], rowId[26]);
				final boolean isPlanned6Same = StringUtils.equals(rowId[15], rowId[27]);
				...
				// 従業員番号
				final Integer jgiNo = ConvertUtil.parseInteger(rowId[1]);
				// 品目コード
				...
				// 更新後月初計画1
				final Long plannedValue1 = ConvertUtil.parseLong(rowId[17]);
				// 更新後月末見込1
				final Long expectedValue1 = ConvertUtil.parseLong(rowId[18]);
				// 更新後月初計画2
				final Long plannedValue2 = ConvertUtil.parseLong(rowId[19]);
				// 更新後月末見込2
				final Long expectedValue2 = ConvertUtil.parseLong(rowId[20]);
				// 更新後月初計画3
				final Long plannedValue3 = ConvertUtil.parseLong(rowId[21]);
				// 更新後月末見込3
				final Long expectedValue3 = ConvertUtil.parseLong(rowId[22]);
				// 更新後月初計画4
				final Long plannedValue4 = ConvertUtil.parseLong(rowId[23]);
				// 更新後月末見込4
				final Long expectedValue4 = ConvertUtil.parseLong(rowId[24]);
				// 更新後月初計画5
				final Long plannedValue5 = ConvertUtil.parseLong(rowId[25]);
				// 更新後月末見込5
				final Long expectedValue5 = ConvertUtil.parseLong(rowId[26]);
				// 更新後月初計画6
				final Long plannedValue6 = ConvertUtil.parseLong(rowId[27]);
				// 更新後月末見込6
				final Long expectedValue6 = ConvertUtil.parseLong(rowId[28]);
