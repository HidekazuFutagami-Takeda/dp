...
/**
 * Dps202C00((医)特定施設個別計画施設一覧画面(営業所案))のフォームクラス
 *
 * @author stakeuchi
 */
public class Dps202C00Form extends DpActionForm {
	 ...
	 * DPS202C00_DATA_R
	 */
	public static final BoxKey DPS202C00_DATA_R = new BoxKeyPerClassImpl(Dps202C00Form.class, SpecialInsPlanResultDto.class);

	/**
	 * DPS202C10_DATA_R
	 */
	public static final BoxKey DPS202C01_DATA_R = new BoxKeyPerClassImpl(Dps202C00Form.class, SpecialInsPlanForVacResultDto.class);

	/**
	 * 2022/6/21 Y.Taniguchi バックログNo.21　組織に紐づく都道府県をプルダウンに表示する
	 * 都道府県プルダウン リクエストデータ
	 */
	public static final BoxKey DPS202C00_DATA_PREFECTURE_LIST = new BoxKeyPerClassImpl(Dps202C00Form.class, CodeAndValue.class);

	/**
	 * 市区郡町村プルダウン リクエストデータ
	 */
	public static final BoxKey DPS202C00_DATA_ADDR_CODE_CITY_LIST = new BoxKeyPerClassImpl(Dps202C00Form.class, JisCodeMstResultDto.class);

	/**
	 * 削除権限
	 */
	public static final DpAuthority DPS202C00_DEL_AUTH = new DpAuthority( AuthType.EDIT);
