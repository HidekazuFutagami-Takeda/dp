...
/**
 * Dps914C00(組織・従業員検索画面)のフォームクラス
 * 
 * @author khashimoto
 */
public class Dps914C00Form extends DiaDpActionForm {
	 ...
	 * 組織・従業員検索結果のキー値
	 */
	public static final BoxKey SOS_JGI_LIST_DTO_KEY_R = new BoxKeyPerClassImpl(Dps914C00Form.class, JgiMst.class);
