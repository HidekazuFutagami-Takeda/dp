 ...
 * @author khashimoto
 */
public class Dps912C04Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey TMS_LIST_KEY_R = new BoxKeyPerClassImpl(Dps912C04Form.class, TmsTytenMstResultsListDto.class);
	...
	public TmsTytenMstScDto convertTmsTytenMstScDto() throws Exception {
		...
		return new TmsTytenMstScDto(null, null, null, null, null, null, hontenMeiKn, jgiNo, insType, null);
	}
