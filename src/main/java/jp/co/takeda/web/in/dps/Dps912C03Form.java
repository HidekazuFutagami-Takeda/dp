 ...
 * @author khashimoto
 */
public class Dps912C03Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey TMS_LIST_KEY_R = new BoxKeyPerClassImpl(Dps912C03Form.class, TmsTytenMstTenkaiListDto.class);
	 ...
	 * 現在のページ番号を設定する。
	 *
	 * @param crntPageNo3 現在のページ番号
	 */
	public void setCrntPageNo3(Integer crntPageNo3) {
		this.crntPageNo3 = crntPageNo3;
	}
