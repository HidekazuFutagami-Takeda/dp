...
/**
 * Dpm200C01((ワ)施設別計画編集画面)のフォームクラス
 *
 * @author stakeuchi
 */
public class Dpm200C01Form extends DpActionForm {
	 ...
	 * 検索結果(集計行)取得キー
	 */
	public static final BoxKey DPM200C01_DATA_R_SEARCH_RESULT_TOTAL = new BoxKeyPerClassImpl(Dpm200C01Form.class, InsPlanForVacResultDetailTotalDto.class);

	/**
	 * 検索結果取得キー
	 */
	public static final BoxKey DPM200C01_DATA_R_SEARCH_RESULT = new BoxKeyPerClassImpl(Dpm200C01Form.class, InsPlanForVacResultDto.class);
