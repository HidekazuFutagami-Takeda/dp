 ...
 * @author khashimoto
 */
public class Dps912C02Form extends DiaDpActionForm {
	 ...
	 * 検索結果のキー値
	 */
	public static final BoxKey TMS_LIST_KEY_R = new BoxKeyPerClassImpl(Dps912C02Form.class, TmsTytenMstListDto.class);
	 ...
	 * 現在のページ番号を設定する。
	 * 
	 * @param crntPageNo2 現在のページ番号
	 */
	public void setCrntPageNo2(Integer crntPageNo2) {
		this.crntPageNo2 = crntPageNo2;
	}
